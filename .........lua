if _G.MainScriptLoaded then
 ...
 local whitelist = { 4649811121, 6230225552, 2842708872, 4714810176, 7117568917, 1906427425, 4513303412, 3247087089, 7388873906, 6141086293,
 } 
...
local window = library:AddWindow("Monster Clan | Script By F-518", {
    main_color = Color3.fromRGB(153, 0, 0), -- Custom emerald green color
...
rebirth:AddLabel("Player Farm Settings")
